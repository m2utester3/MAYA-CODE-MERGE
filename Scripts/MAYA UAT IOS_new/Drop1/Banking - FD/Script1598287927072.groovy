...
not_run: Mobile.getText(findTestObject('MAYA UAT IOS/Drop1/banking - loan and FD/XCUIElementTypeOther - Interest Payment Mode Add to Principal'), 
    0)

not_run: Mobile.getText(findTestObject('MAYA UAT IOS/Drop1/banking - loan and FD/XCUIElementTypeOther - Instructions on Maturity Auto-Renewal'), 
    0)
