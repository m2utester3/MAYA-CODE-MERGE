...
Mobile.setText(findTestObject('MAYA UAT IOS/Drop1/one tap authorization/XCUIElementTypeSecureTextField'), 'pass1234', 0)
...
Mobile.setText(findTestObject('MAYA UAT IOS/Drop1/one tap authorization/XCUIElementTypeTextField - Your ID number'), '810101104144', 
    0)
...
not_run: Mobile.tap(findTestObject('MAYA UAT IOS/Drop1/one tap authorization/XCUIElementTypeOther - Confirm (1)'), 0)

not_run: Mobile.getText(findTestObject('MAYA UAT IOS/Drop1/one tap authorization/XCUIElementTypeOther - One-Tap Authorisation'), 
    0)
