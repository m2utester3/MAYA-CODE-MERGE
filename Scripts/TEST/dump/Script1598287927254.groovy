...
not_run: Mobile.tap(findTestObject('MAYA SIT v127 - trans own acct/Transfer - Instant/android.widget.TextView0 - MAYBANK'), 
    0)

not_run: Mobile.setText(findTestObject('MAYA SIT v127 - trans own acct/Transfer - Instant/android.widget.EditText0 (1)'), 
    '514012029036', 0)

not_run: Mobile.tap(findTestObject('MAYA SIT v127 - trans own acct/Transfer - Instant/android.widget.EditText0 (1)'), 0, 
...
'keypad - ok'
not_run: Mobile.tap(findTestObject('MAYA SIT Regression SPY/UAT - transfer Select own account - OK button'), 0)
...
not_run: Mobile.tap(findTestObject('MAYA SIT v127 - trans own acct/Transfer - Instant/android.widget.EditText0 - katalon 3rd party'), 
    0)
...
not_run: Mobile.tap(findTestObject('MAYA drop 2 SPY/UAT - transfer CONTINUE button'), 0)

not_run: Mobile.getText(findTestObject('MAYA SIT v127 - trans own acct/Transfer - Instant/android.widget.TextView0 - Today'), 
    0)

not_run: Mobile.getText(findTestObject('MAYA SIT v127 - trans own acct/Transfer - Instant/android.widget.TextView0 - MAYBANK (1)'), 
    0)

not_run: Mobile.getText(findTestObject('MAYA SIT v127 - trans own acct/Transfer - Instant/android.widget.TextView0 - katalon 3rd party'), 
    0)
...
not_run: Mobile.setText(findTestObject('MAYA SIT v127 - trans own acct/Transfer - Instant/android.widget.EditText0 - Optional'), 
    'instant', 0)
...
not_run: Mobile.tap(findTestObject('MAYA SIT v127 - trans own acct/Transfer - Instant/android.widget.TextView0 - Transfer Now'), 
    0)
...
not_run: Mobile.getText(findTestObject('MAYA SIT v127 - trans own acct/Transfer - Instant/android.widget.TextView0 - Transfer successful'), 
    0)
...
not_run: Mobile.getText(findTestObject('MAYA SIT v127 - trans own acct/Transfer - Instant/android.widget.TextView0 - 179839600M'), 
    0)

not_run: Mobile.getText(findTestObject('MAYA SIT v127 - trans own acct/Transfer - Instant/android.widget.TextView0 - 16 Apr 2020 0809 pm'), 
    0)

not_run: Mobile.getText(findTestObject('MAYA SIT Regression SPY/UAT - transfer own SHARE Receipt'), 0)

not_run: Mobile.tap(findTestObject('MAYA SIT Regression SPY/UAT - transfer own SHARE Receipt'), 0)
...
not_run: Mobile.tap(findTestObject('MAYA SIT Regression SPY/UAT - transfer own SHARE Receipt BACK btn'), 0)

not_run: WebUI.delay(5)

not_run: Mobile.tap(findTestObject('MAYA SIT v127 - trans own acct/Transfer - Instant/android.widget.TextView0 - Done'), 
    0)

not_run: Mobile.tap(findTestObject('MAYA SIT v127 - trans own acct/Transfer - Instant/android.widget.TextView0 - Transfer'), 
    0)
...
Mobile.tap(findTestObject('MAYA SIT v127 - trans own acct/Transfer - Instant/spy/interbank - search box 1'), 0)

WebUI.delay(3)

Mobile.setText(findTestObject('MAYA SIT v127 - trans own acct/Transfer - Instant/spy/interbank - search box SET TEXT'), 
    'hong leong', 0)
