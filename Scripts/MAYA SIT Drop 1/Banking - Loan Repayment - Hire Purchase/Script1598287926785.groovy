...
not_run: Mobile.getText(findTestObject('MAYA SIT Regression SPY/loan hp number'), 0)
...
def pss = Mobile.getText(findTestObject('Banking Loans/UAT - Banking Islamic SUCCESS msg'), 0)

Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/bankingLOAN/109.png', FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyEqual(pss, 'Payment successful')
...
def ps33 = Mobile.getText(findTestObject('Banking Loans/UAT - Banking Islamic SUCCESS msg'), 0)

Mobile.verifyEqual(ps33, 'Payment successful')
