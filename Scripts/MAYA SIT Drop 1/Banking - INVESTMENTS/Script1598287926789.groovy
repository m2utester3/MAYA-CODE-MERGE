...
'app launch (uatteam001) (peileng) (Uat_test06)'
...
def info = Mobile.getText(findTestObject('Banking - Investments/UAT - Investment contact bank msg'), 0)

Mobile.verifyEqual(info, 'For any enquiries regarding your account, please call the\nCustomer Care Hotline at')
...
not_run: Mobile.getText(findTestObject('Banking - Investments/android.widget.TextView0 - 7050 1960 0026'), 0)
...
not_run: Mobile.getText(findTestObject('Banking - Investments/android.widget.TextView0 - 7050 1960 0019'), 0)

Mobile.getText(findTestObject('Banking - Investments/UAT - Investment MGIA amount RM'), 0)

Mobile.getText(findTestObject('Banking - Investments/UAT - Investment MGIA gold gram'), 0)
...
not_run: Mobile.tap(findTestObject('Banking - Investments/android.widget.ImageView0 (1)'), 0)
...
Mobile.tap(findTestObject('Banking - Investments/UAT - Investment CROSS btn'), 0)
