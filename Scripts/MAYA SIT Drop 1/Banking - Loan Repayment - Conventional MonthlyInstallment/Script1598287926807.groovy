...
Mobile.setText(findTestObject('Banking Loans/UAT - Banking - Conventional SET PWD'), 'Pass@1278', 0)
...
not_run: Mobile.getText(findTestObject('Banking Loans/android.widget.TextView0 - Transfer (2)'), 0)
...
not_run: Mobile.getText(findTestObject('Banking Loans/UAT - Banking - Conventional Loan'), 0)

not_run: Mobile.getText(findTestObject('Banking Loans/UAT - Banking - Conventional Loan ACCT NUM'), 0)

Mobile.tap(findTestObject('Banking Loans/UAT - Banking - Conventional Loan ACCT NUM'), 0)

Mobile.getText(findTestObject('Banking Loans/android.widget.TextView0 - Pay Loan (1)'), 0)

not_run: Mobile.getText(findTestObject('Banking Loans/android.widget.TextView0 - Maybank Conventional Loan (1)'), 0)

Mobile.getText(findTestObject('Banking Loans/UAT - Banking - Conventional Loan - Anyamount'), 0)
...
Mobile.getText(findTestObject('Banking Loans/UAT - Banking - Conventional Loan - CONFIRMATION BANK NAME'), 0)
