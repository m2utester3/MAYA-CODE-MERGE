...
Mobile.setText(findTestObject('Banking Loans/UAT - Banking - Conventional SET PWD'), 'pass1234', 0)

Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/bankingLOAN/2.png', FailureHandling.CONTINUE_ON_FAILURE)

WebUI.delay(2)

not_run: Mobile.tapAtPosition(985, 1827)
...
not_run: def mil = Mobile.getText(findTestObject('Banking Loans/android.widget.TextView0 - Maybank Islamic Loan'), 0)

not_run: Mobile.verifyEqual(mil, 'Maybank Islamic Loan')

Mobile.tap(findTestObject('Banking Loans/UAT - Banking Islamic ACCT num'), 0)

def pl = Mobile.getText(findTestObject('Banking Loans/UAT - Banking Islamic Pay loan Header'), 0)
...
def aa = Mobile.getText(findTestObject('Banking Loans/UAT - Banking Islamic Any amt'), 0)

Mobile.getText(findTestObject('Banking Loans/UAT - Banking Islamic Any amt VALUE'), 0)

Mobile.tap(findTestObject('Banking Loans/UAT - Banking Islamic Any amt'), 0)
...
Mobile.tap(findTestObject('Banking Loans/UAT - Banking Islamic OK btn'), 0)
...
def ps = Mobile.getText(findTestObject('Banking Loans/UAT - Banking Islamic SUCCESS msg'), 0)

Mobile.verifyEqual(ps, 'Payment successful')
