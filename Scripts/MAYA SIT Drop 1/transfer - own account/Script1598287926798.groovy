...
not_run: Mobile.tap(findTestObject('MAYA SIT v127 - trans own acct/android.widget.TextView0 - Transfer failed'), 0)
...
not_run: Mobile.tap(findTestObject('MAYA SIT v127 - trans own acct/android.widget.ImageView0 (1)'), 0)

not_run: Mobile.scrollToText('M2U History', FailureHandling.CONTINUE_ON_FAILURE)

not_run: Mobile.tap(findTestObject('MAYA SIT v127 - trans own acct/android.widget.TextView0 - Done (1)'), 0)

not_run: WebUI.delay(3)

not_run: Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/transferOwnacc/14.png', FailureHandling.CONTINUE_ON_FAILURE)

'cross button'
not_run: Mobile.tap(findTestObject('MAYA SIT v127 - trans own acct/android.widget.ImageView0 (2)'), 0)

'back button'
not_run: Mobile.tap(findTestObject('MAYA SIT v127 - trans own acct/android.widget.ImageView0 (3)'), 0)
