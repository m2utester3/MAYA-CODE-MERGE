...
Mobile.tap(findTestObject('MAYA SIT Regression SPY/spy reg2/UAT - onboarding - Hello'), 0)
...
Mobile.tap(findTestObject('MAYA SIT Regression SPY/spy reg2/UAT - onboarding Katalon'), 0)
