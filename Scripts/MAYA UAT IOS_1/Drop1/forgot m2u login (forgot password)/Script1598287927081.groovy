...
Mobile.setText(findTestObject('MAYA UAT IOS/Drop1/forgot m2u login/XCUIElementTypeTextField - Confirm new password'), 'Pass@1247', 
    0)
...
Mobile.setText(findTestObject('MAYA UAT IOS/Drop1/forgot m2u login/XCUIElementTypeSecureTextField'), 'Pass@1247', 0)
