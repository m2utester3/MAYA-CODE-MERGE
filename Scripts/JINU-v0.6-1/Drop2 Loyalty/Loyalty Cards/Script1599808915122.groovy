...
not_run: Mobile.tap(findTestObject('Maya/Loyalty Cards/android.widget.ImageView0'), 0)

not_run: Mobile.tap(findTestObject('Maya/Loyalty Cards/android.widget.TextView0 - Add Cards'), 0)
...
Mobile.swipe(661, 1308, 652, 1185)
...
Mobile.tapAtPosition(929, 1065)

Mobile.tapAtPosition(651, 1102)
...
Mobile.tapAtPosition(925.7, 1522.5)
...
Mobile.tapAtPosition(536.5, 1740.5)
...
not_run: Mobile.tap(findTestObject('Maya/Loyalty Cards/android.widget.ImageView0 (5)'), 0)
...
Mobile.tapAtPosition(81.6, 204.8)
...
not_run: Mobile.tap(findTestObject('Maya/KLIA/android.widget.TextView0 - More (1)'), 0)

not_run: Mobile.tap(findTestObject('Maya/KLIA/android.widget.TextView0 - Notifications'), 0)

not_run: Mobile.tap(findTestObject('Maya/KLIA/android.widget.TextView0 - Got It'), 0)

not_run: Mobile.getText(findTestObject('Maya/KLIA/android.widget.TextView0 - Today (1)'), 0)
