...
Mobile.tap(findTestObject('MAYA UAT IOS/Drop1/DuitNow - NRIC/XCUIElementTypeOther - ArmyPolice ID'), 0)
...
Mobile.getText(findTestObject('MAYA UAT IOS/Drop1/DuitNow - Army/XCUIElementTypeStaticText - Enter Army  Police ID'), 0)

Mobile.setText(findTestObject('MAYA UAT IOS/Drop1/DuitNow - Army/XCUIElementTypeTextField - nricNumber'), 'G54178', 0)

Mobile.takeScreenshot('/Users/mosaj/katalon/screenshotsIOS/duitnow/4.png', FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tapAtPosition(width * 0.90740, height * 0.94375)

Mobile.getText(findTestObject('MAYA UAT IOS/Drop1/DuitNow - Army/XCUIElementTypeStaticText - JOHARI'), 0)

Mobile.getText(findTestObject('MAYA UAT IOS/Drop1/DuitNow - Army/XCUIElementTypeStaticText - ArmyPolice ID'), 0)
...
Mobile.setText(findTestObject('MAYA UAT IOS/Drop1/DuitNow - Mobile/XCUIElementTypeTextField - inputReference'), 'ios duit ARMY', 
    0)
