...
Mobile.setText(findTestObject('MAYA UAT IOS/Drop2/Tabung Group/XCUIElementTypeTextField - Enter Tabung name'), 'Tabung future', 
    0)
...
Mobile.setText(findTestObject('MAYA UAT IOS/Drop2/Tabung Group/XCUIElementTypeSecureTextField'), 'Pass@1278', 0)
...
not_run: Mobile.getText(findTestObject('MAYA UAT IOS/Drop2/Tabung Group/XCUIElementTypeStaticText - Whos saving'), 0)

Mobile.tap(findTestObject('MAYA UAT IOS/Drop2/Tabung Group/XCUIElementTypeOther - '), 0)

Mobile.getText(findTestObject('MAYA UAT IOS/Drop2/Tabung Group/XCUIElementTypeStaticText - Group Tabung Must-Know'), 0)

Mobile.takeScreenshot('/Users/mosaj/katalon/screenshotsIOS/tabung/29.png', FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('MAYA UAT IOS/Drop2/Tabung Group/XCUIElementTypeOther - Got It'), 0)

Mobile.tap(findTestObject('MAYA UAT IOS/Drop2/Tabung Group/XCUIElementTypeOther - Got It'), 0)

Mobile.getText(findTestObject('MAYA UAT IOS/Drop2/Tabung Group/XCUIElementTypeStaticText - Add Friends'), 0)

Mobile.takeScreenshot('/Users/mosaj/katalon/screenshotsIOS/tabung/30.png', FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('MAYA UAT IOS/Drop2/Tabung Group/XCUIElementTypeOther - Batman 010 2264 481 mayaImage'), 0)

Mobile.getText(findTestObject('MAYA UAT IOS/Drop2/Tabung Group/XCUIElementTypeOther - Add'), 0)

Mobile.takeScreenshot('/Users/mosaj/katalon/screenshotsIOS/tabung/31.png', FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('MAYA UAT IOS/Drop2/Tabung Group/XCUIElementTypeOther - Add'), 0)
...
Mobile.getText(findTestObject('MAYA UAT IOS/Drop2/Tabung Group/XCUIElementTypeStaticText - You'), 0)

Mobile.getText(findTestObject('MAYA UAT IOS/Drop2/Tabung Group/XCUIElementTypeStaticText - RM 14.00'), 0)

Mobile.getText(findTestObject('MAYA UAT IOS/Drop2/Tabung Group/XCUIElementTypeStaticText - Test'), 0)

Mobile.getText(findTestObject('MAYA UAT IOS/Drop2/Tabung Group/XCUIElementTypeStaticText - RM 14.00 (1)'), 0)

Mobile.getText(findTestObject('MAYA UAT IOS/Drop2/Tabung Group/XCUIElementTypeOther - Add More'), 0)

Mobile.getText(findTestObject('MAYA UAT IOS/Drop2/Tabung Group/XCUIElementTypeOther - Continue (3)'), 0)

Mobile.tap(findTestObject('MAYA UAT IOS/Drop2/Tabung Group/XCUIElementTypeOther - Continue (3)'), 0)
