...
not_run: var153 = Mobile.getText(findTestObject('MAYA Drop 2/SplitBills/android.widget.TextView0 - Got an IOU situation'), 
    0)

not_run: Mobile.verifyEqual(var153, 'Got an IOU situation?')

not_run: var154 = Mobile.getText(findTestObject('MAYA Drop 2/SplitBills/UAT - SplitBill msg evenly seprate'), 0)

not_run: Mobile.verifyEqual(var154, 'Evenly or separately,\nit\'s time to split the bill with friends!')
...
not_run: Mobile.getText(findTestObject('MAYA Drop 2/SplitBills/android.widget.TextView0 - Got an IOU situation'), 0)

not_run: Mobile.getText(findTestObject('MAYA Drop 2/SplitBills/android.widget.TextView0 - Split a Bill'), 0)
...
not_run: var185 = Mobile.getText(findTestObject('MAYA Drop 2/SplitBills/android.widget.TextView0 - Reference ID'), 0)

not_run: Mobile.verifyEqual(var185, 'Reference ID')

not_run: Mobile.getText(findTestObject('MAYA Drop 2/SplitBills/android.widget.TextView0 - MB449916B'), 0)
