...
if (Mobile.verifyElementExist(findTestObject('MAYA SIT Regression SPY/spy reg2/UAT Tabung Tab to View'), 0)) {
    ...
    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/tabung SPY/tabung - Group AMOUNT YOU VALUE'), 
        0)

    Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/tabung SPY/tabung - Group AMOUNT frnd 1'), 0)

    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/tabung SPY/tabung - Group AMOUNT frnd 1 value'), 
        0)
