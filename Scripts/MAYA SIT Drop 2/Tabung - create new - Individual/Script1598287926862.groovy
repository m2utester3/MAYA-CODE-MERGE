...
if (Mobile.verifyElementExist(findTestObject('MAYA SIT Regression SPY/spy reg2/UAT Tabung Tab to View'), 0)) {
    ...
    Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/spy/tabung - New Tabung'), 0)

    Mobile.tap(findTestObject('MAYA Drop 2/Tabung-create new/spy/tabung - New Tabung'), 0)
    ...
    Mobile.tap(findTestObject('MAYA Drop 2/Tabung-create new/spy/tabung - save amount OK btn'), 0)
    ...
    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/android.widget.TextView0 - MAY (1)'), 0)
    ...
    not_run: Mobile.tap(findTestObject('MAYA Drop 2/Tabung-create new/android.widget.TextView0 - RM 20.89 (2)'), 0)
    ...
    not_run: Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/Tabung/17.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    def otpTabungCreate = Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/spy/Tabung TAC'), 0)
    ...
    Mobile.tap(findTestObject('MAYA Drop 2/Tabung-create new/spy/tabung TAC ok btn'), 0)
    ...
    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/Tabung - createnew - New Tabung/tabung - create new - TaptoView - NewTabung 22'), 
        0)
    ...
    not_run: Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/Tabung - createnew - New Tabung/tabung - create new - TaptoView - NewTabung 25'), 
        0)
