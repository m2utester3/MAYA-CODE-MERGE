...
not_run: Mobile.getText(findTestObject('MAYA Drop 2/SendMoney/android.widget.TextView0 - Need to ask for money'), 0)

not_run: Mobile.getText(findTestObject('MAYA Drop 2/SendMoney/android.widget.TextView0 - Get your dues paid but ina less awkward wayTrack and send reminders all here.'), 
    0)
...
Mobile.tap(findTestObject('MAYA Drop 2/SendMoney/spy sept/UAT send money search box 1'), 0)

Mobile.setText(findTestObject('MAYA Drop 2/SendMoney/spy sept/UAT send money search box SET TEXT'), 'Batman', 0)
...
Mobile.tap(findTestObject('MAYA Drop 2/SendMoney/spy sept/UAT send money DOne back btn 1'), 0)
...
not_run: Mobile.getText(findTestObject('MAYA Drop 2/SendMoney/android.widget.TextView0 - Savings Account'), 0)
