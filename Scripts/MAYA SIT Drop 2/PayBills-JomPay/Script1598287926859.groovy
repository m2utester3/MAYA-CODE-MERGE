...
not_run: Mobile.getText(findTestObject('MAYA drop 2 SPY/jompay - TAC text'), 0)

not_run: Mobile.getText(findTestObject('MAYA drop 2 SPY/jompay - TAC text2'), 0)

not_run: Mobile.getText(findTestObject('MAYA drop 2 SPY/jompay - TAC text3'), 0)
...
not_run: Mobile.getText(findTestObject('MAYA drop 2 SPY/jompay - add to fav2'), 0)
