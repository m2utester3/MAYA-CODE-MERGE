...
not_run: Mobile.getText(findTestObject('MAYA Drop 2/General Settings/android.widget.TextView0 - Setup Scan  Pay'), 0)
...
not_run: Mobile.tap(findTestObject('MAYA Drop 2/General Settings 2/android.widget.TextView0 - Continue'), 0)
