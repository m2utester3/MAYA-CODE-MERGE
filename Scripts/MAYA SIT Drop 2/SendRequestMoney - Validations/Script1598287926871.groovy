...
Mobile.tap(findTestObject('MAYA Drop 2/SendRequestMoney-Validations/android.widget.TextView0 - Savings Account'), 0)
...
not_run: Mobile.getText(findTestObject('MAYA Drop 2/SendRequestMoney-Validations/android.widget.TextView0 - Send  Request (4)'), 
    0)
...
not_run: var9 = Mobile.getText(findTestObject('MAYA Drop 2/SendRequestMoney-Validations/android.widget.TextView0 - Transfer'), 
    0)
