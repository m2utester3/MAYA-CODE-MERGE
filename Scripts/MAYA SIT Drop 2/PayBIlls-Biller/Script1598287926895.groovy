...
Mobile.getText(findTestObject('MAYA Drop 2/JomPay/spy/UAT Paybills - Current Account selection'), 0)

Mobile.tap(findTestObject('MAYA Drop 2/JomPay/spy/UAT Paybills - Current Account selection'), 0)

Mobile.getText(findTestObject('MAYA Drop 2/JomPay/spy/UAT Paybills - from accounts - Pay Bills'), 0)

Mobile.tap(findTestObject('MAYA Drop 2/JomPay/spy/UAT Paybills - from accounts - Pay Bills'), 0)
...
Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/jomPay/52a.png', FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('MAYA Drop 2/SendMoney-MAE/android.widget.TextView0 - Approve'), 0)

not_run: def otpJompay = Mobile.getText(findTestObject('MAYA Drop 2/Forgot M2U Login/spy/Fortgot Login - OTP number'), 0)

not_run: Mobile.takeScreenshot('/Users/mosaj/katalon/screenshots/jomPay/52.png', FailureHandling.CONTINUE_ON_FAILURE)
...
var5 = Mobile.getText(findTestObject('MAYA Drop 2/JomPay/spy/UAT Paybills - Date  Time'), 0)

Mobile.verifyEqual(var5, 'Date & time')

Mobile.getText(findTestObject('MAYA Drop 2/JomPay/spy/UAT Paybills -  JomPAY reference'), 0)

Mobile.getText(findTestObject('MAYA Drop 2/JomPay/spy/UAT Paybills - jompay value'), 0)
...
not_run: Mobile.tap(findTestObject('MAYA drop 2 SPY/jompay entry from m2u - 1'), 0)
...
Mobile.setText(findTestObject('MAYA drop 2 SPY/jompay - paybills - biller SET TEXT'), 'Astro', 0)
...
Mobile.setText(findTestObject('MAYA Drop 2/PayBills-Jompay/android.widget.EditText0 (4)'), '0838858594', 0)
